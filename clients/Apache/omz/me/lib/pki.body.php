...
?>
&raquo;
Установка секретного ключа на компютер пользователя описана в <A hRef='/omz/help/pfx/'>Справке</A>
<BR />
&raquo;
Проверить, установлен ли (корректно) секретный ключ, можно зайдя на <A hRef='/omz/help/pfx/test/'>спецстраницу</A>
